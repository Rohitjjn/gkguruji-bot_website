  ...
  return (
    <div className="fixed inset-0 z-[100] bg-midnight-950 flex flex-col">
      ...
      <div className="w-full h-1 bg-white/5">
        <div className="h-full bg-gold-500" initial={{ width: `${((qIndex)/totalQ)*100}%` }} animate={{ width: `${((qIndex + 1)/totalQ)*100}%` }} />
      </div>
      <div className="flex-1 overflow-y-auto p-6 pb-20">
         <div className="max-w-2xl mx-auto mt-4 md:mt-10">
            ...
            <div className="space-y-3">
               ...
               {quizState === 'feedback' && (
                 <div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="mt-6 p-4 rounded-xl bg-gold-500/10 border border-gold-500/20">
        ...
        <div className="container mx-auto px-6 md:px-12 relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <motion.h1 className="text-5xl md:text-7xl font-serif font-bold leading-[1.1] mb-6">Unlock Your <br/><span className="text-transparent bg-clip-text bg-gold-gradient">Dream Job.</span></motion.h1>
              <motion.p className="text-lg text-slate-300 mb-10 max-w-lg font-light">{t.hero.subheadline}</motion.p>
        ...
        <div className="container mx-auto px-6 md:px-12">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {t.features.list.map((feature, idx) => (
              <div key={feature.id} className="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm hover:shadow-xl transition-all group">
