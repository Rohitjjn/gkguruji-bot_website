...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen font-sans text-slate-800">
      ...
      <header className={`fixed top-0 w-full z-50 transition-all duration-500 ${scrolled ? 'bg-white/95 border-b border-slate-200 py-4 shadow-sm' : 'bg-transparent py-6'}`}>
